...
#+date: <2014-03-04>
#+filetags: python virtualenv setv
#+setupfile: ../org-templates/post.org

=setv=: /Lightweight Python virtual environment manager/

*Update [March 28, 2019]*: The [[https://gitlab.com/psachin/setV][setV]] project is migrated from GitHub to Gitlab.

*Update [March 30, 2016]*: I created [[https://github.com/psachin/setV][setV]] as a separate project with installer
and readme. This post is quite old.
